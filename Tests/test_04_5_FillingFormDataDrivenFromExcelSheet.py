# Using an Excel spreadsheet as data driven execution for the testcases:
...
class TestFormDataDriven(BaseClassUtilities):
    ...
    # selecting data from the specific STATIC METHOD (get_loging_test_data("TEST")) for selecting the test data we want
    # to use for the test.
    ...
    # format: "className.methodName" exmple "AllTestsTestData.get_loging_test_data("TEST")".
    @pytest.fixture(params=AllTestsTestData.get_loging_test_data("TEST"))
